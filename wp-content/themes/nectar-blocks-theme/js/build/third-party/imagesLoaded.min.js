/*! For license information please see imagesLoaded.min.js.LICENSE.txt */ ! function(e, t) {
...
function(e, t) {
    ...
    function n(e, t, o) {
        ...
        }(r), this.options = i({}, this.options), "function" == typeof t ? o = t : i(this.options, t), o && this.on("always", o), this.getImages(), s && (this.jqDeferred = new s.Deferred), void setTimeout(this.check.bind(this))) : void h.error("Bad element for imagesLoaded " + (r || e))
    }
